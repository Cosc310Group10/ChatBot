...
public class RyanReynolds {
  ...
  // Information below
    ...
    //other awards
    private ArrayList<String> otherAwards = new ArrayList<>(Arrays.asList("People Magazine's Sexiest Man Alive","Hollywood Walk of Fame","Governor General's Performing Arts Awards: National Art Centre Award"));
