...
public class RyanReynolds {
 ...
 //Ryan Reynolds Movie objects / attributes below
    ...
    private Movie deadpool = new Movie(8,"Deadpool",2016,"R",deadpoolCast,"Tim Miller","Action and Comedy",deadpoolAwards,"783,100,000","Vancouver","48 days","1hr 48m","58,000,000");
    ...
    private Movie deadpool2 = new Movie(7.7,"Deadpool 2",2018,"R",deadpool2Cast,"David Leitch","Action and Comedy",deadpool2Awards,"785,000,000","Vancouver","N/A", "2 hours","110,000,000");
    ...
    private Movie freeGuy = new Movie(7.2,"Free Guy",2021,"PG-13",freeGuyCast,"Shawn Levy","Action and Comedy",freeGuyAwards,"331,500,000","Boston","N/A","1hr 55m","125,000,000");
    ...
    private Movie ripd = new Movie(5.6,"R.I.P.D",2013,"PG-13",ripdCast,"Robert Schwentke","Action and Comedy",ripdAwards,"78,300,000","Boston","N/A","1hr 36m","154,000,000");
    ...
    private Movie greenLantern = new Movie(5.5,"Green Lantern",2011,"PG-13",greenLanternCast,"Martin Campbell","Action and Sci-Fi",greenLanternAwards,"219,900,000","Los Angeles","Approximately 6 months","2hr 3m","200,000,000");
    ...
    private Movie buried = new Movie(7.0,"Buried",2010,"R",buriedCast,"Rodrigo Cortes","Drama, Mystery, and Thriller",buriedAwards,"21,300,000","Barcelona","16 days","1hr 35m","2,000,000");
    ...
    private Movie sixUnderground = new Movie(6.1,"6 Underground",2019,"R",sixUndergroundCast,"Michael Bay","Action and Thriller",sixUndergroundAwards,"N/A","Abu Dhabi","30 days","2hr 8m","150,000,000");
    ...
    private Movie redNotice = new Movie(6.3,"Red Notice",2021,"PG-13",redNoticeCast,"Rawson Marshall Thurber","Action, Comedy, and Thriller",redNoticeAwards,"2,000,000","Atlanta","N/A","1hr 57m","200,000,000");
    ...
    private Movie selfLess = new Movie(6.5,"Self/Less",2015,"PG-13",selfLessCast,"Tarsem Singh","Action, Mystery, and Sci-Fi",selfLessAwards,"30,500,000","New Orleans","N/A","1hr 57m","26,000,000");
    ...
    private Movie theHitmansBodyguard = new Movie(6.9,"The Hitman's Bodyguard",2017,"R",theHitmansBodyguardCast,"Patrick Hughes","Action, Comedy, and Crime",theHitmansBodyguardAwards,"176,600,000","Amsterdam","N/A","1hr 58m","69,000,000");
    ...
    private Movie changeUp = new Movie(6.3,"The Change-up",2011,"R",changeUpCast,"David Dobkin","Comedy and Fantasy",changeUpAwards,"75,500,000","Alpharetta, Georgia","N/A","1hr 52m","52,000,000");
    ...
    private Movie theProposal = new Movie(6.7,"The Proposal",2009,"PG-13",theProposalCast,"Anne Fletcher","Comedy, Drama, Romance",theProposalAwards,"317,400,000","Sitka, Alaska","2 months","1hr 48m","40,000,000");
