...
//---------------------------------------------------------------------------------------------------------
  // this is a method which fills in each movie map with its respective key and value depending on which map it is
...
//---------------------------------------------------------------------------------------------------------
  // this is a method which fills in the personal map with its respective key and value depending on which map it is
  // via a process of elimination by if and else which determines what the key will be 
  public static void fillInPersonalMap(HashMap<String,String> map){
    for(int i=0; i<personalQuestion.size();i++){
      if(personalQuestion.get(i) == "height"){
        ...
        map.put(personalQuestion.get(i).toLowerCase(),"I have " + r.getinstagramFollowers()+" followers on Instagram");
  ...
  public static void analyzeInput(String userInput) {
    ...
    for(int i=0; i<greetingResponses.size();i++){  
      // if the user input contains a greeting we simply call the greeting function to respond
      ...
      // if the userInput does not contain a movie title, 
        ...
        for(int k=0; k<personalQuestion.size();k++){
          ...
          if(userInput.contains(personalQuestion.get(k).toLowerCase())){
            ...
            //then we send the user input and the personal question asked about to a chat function which determines
            // the robots reponse
...
//---------------------------------------------------------------------------------------------------------
  // This is the movie chat function for the chatbot
...
//---------------------------------------------------------------------------------------------------------
    ...
    // This is the personal chat function for the chatbot
...
// ------------------------------------------------------------------------------------------------------------------
  ...
  public static void defaultResponse() {
    ...
    // statement set as the chat bot's default response to a question it does not know
