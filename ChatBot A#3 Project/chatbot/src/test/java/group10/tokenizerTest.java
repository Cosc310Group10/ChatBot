...
public class tokenizerTest {
    ...
    //testing true input, where this is the only case for creating the tokenized input
    @Test
    @DisplayName("Repeated Testing")
    @ParameterizedTest
    @ValueSource(strings = {"who is your wife"}) //add a whole bunch of tests, **********************************************NOTE THIS WONT WORK WITH PERIODS ETC
    public void testTokenizeIsTRUE(String input) throws IOException
    {
        ...
        //here we ALSO tokenize the user input but with a very straightforward way without a method
        // we simply just split the input at the space and we check
        String[] check = input.split(" ");
        // if the tokenized input equals to the input split at the string then we return true, otherwise false, by checking if they equal eachother
